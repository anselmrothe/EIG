...
NODES = {
    ...
    'sum': NodeConfig('sum', 1, DataType.NUMBER, [(DataType.SET_N, ), (DataType.SET_B, )]),
    ...
    'any': NodeConfig('any', 1, DataType.BOOLEAN, (DataType.SET_B, )),
    'all': NodeConfig('all', 1, DataType.BOOLEAN, (DataType.SET_B, )),
    ...
    # set functions
    'map': NodeConfig('map', 2, [DataType.SET_B, DataType.SET_B, DataType.SET_L, DataType.SET_N], 
    ...
    'set': NodeConfig('set', -1, [DataType.SET_L, DataType.SET_S], [(DataType.LOCATION, ), (DataType.COLOR, )]),
    ...
    'lambda': NodeConfig('lambda', 2, [DataType.LAMBDA_FXB, DataType.LAMBDA_FXL, DataType.LAMBDA_FXN, DataType.LAMBDA_FYB], 
